...
A tela **Organograma > Rede de conhecimentos** conecta pessoas a conceitos e usa a cobertura ponderada para sinalizar risco. O perfil mostra domínios e perfis profissionais inferidos, o dashboard administrativo inclui o Radar de conhecimento e o administrador pode simular a saída de um colaborador para visualizar perda de cobertura, conhecimentos órfãos e possíveis destinatários para transferência.

O motor considera conhecimento declarado, publicações associadas, atualidade, documentação, concentração e relevância para calcular cobertura e risco. Os limites iniciais ficam em `knowledge_risk_config` e podem ser refinados sem mudar a área oficial de ninguém. A arquitetura está detalhada em `INTELIGENCIA_CONHECIMENTO.md`.

...
## Inteligência de conhecimento (MIND 1.1)

A versão 1.1 amplia o catálogo para **1.580 registros / 1.563 conceitos canônicos em 20 macroáreas** e adiciona uma camada de inteligência organizacional. Um mesmo conceito pode ter afinidade ponderada com várias áreas, perfis profissionais e capacidades; a área oficial e o cargo do colaborador nunca são alterados automaticamente.

A tela **Organograma > Rede de conhecimentos** conecta pessoas a conceitos. Na versão **1.1.1**, as cores indicam alertas qualitativos baseados nas evidências da empresa, não importância nem cobertura presumida. Autores de publicações e detentores autodeclarados são tratados separadamente. O perfil mantém os domínios e perfis profissionais inferidos para descoberta, sem influenciar o risco.

O Dashboard mostra **Riscos do Conhecimento da Empresa**: só entram conhecimentos com declarações ou publicações registradas. Itens exclusivos do catálogo não geram alertas. Não há criticidade, importância atribuída, cobertura inferida ou porcentagem de risco/documentação. A simulação de saída preserva as publicações e mostra perdas de detentores declarados ativos. Consulte `INTELIGENCIA_CONHECIMENTO.md` para regras e contratos e `ATUALIZACAO_RISCOS.md` para instalar sem perder o banco.

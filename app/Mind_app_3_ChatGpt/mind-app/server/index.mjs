...
active();
 ...
 if(path==='/api/profile'&&req.method==='POST'){
  if(b.knowledge_ids!==undefined){
   ...
   const ids=[...new Set(b.knowledge_ids)];if(ids.length>20)fail('Escolha até 20 conhecimentos para o perfil.');
   ...
   for(const knowledgeId of ids)await tx.all('INSERT INTO user_knowledge(user_id,knowledge_id) VALUES(?,?)',[user.id,knowledgeId]);
  }
...
const files={'/':'index.html','/admin':'index.html','/app.js':'app.js','/search-utils.mjs':'search-utils.mjs','/knowledge-guides.mjs':'knowledge-guides.mjs','/dashboard-view.mjs':'dashboard-view.mjs','/style.css':'style.css'};
